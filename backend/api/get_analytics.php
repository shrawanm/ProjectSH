...
try {
    ...
    //this loop $product_counts contains all products with their sales and revenue counts
    // Example result:
    // [
    //   'Pashmina' => ['sales' => 150, 'revenue' => 750000],
    //   'Yak Wool' => ['sales' => 120, 'revenue' => 360000],
    //   'Crafts' => ['sales' => 80, 'revenue' => 160000]
    // ]
    ...
    for ($i = 6; $i >= 0; $i--) {
        ...
        $daily_sales[] = [
            ...
            'revenue' => floatval($day_data['revenue'] ?? 0)
        ];
    }
        echo json_encode([
        'status' => 'success',
