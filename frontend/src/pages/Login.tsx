        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-bg-card dark:bg-bg-card text-text-muted">
                Or continue with
              </span>
            </div>
          </div>
          ...
          {/* Google Sign-in */}
          <button className="mt-6 w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 dark:border-gray-700 rounded-md hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
