  ...
  if (validateForm()) {
    try {
      ...
      if (result.status === 'success') {
        //navigate to payment, passing the DB ID for reference
        navigate('/payment', { 
          state: { 
            ...checkoutPayload, 
            ...
            <div className="bg-bg-card dark:bg-bg-card p-6 rounded-lg shadow-sm border border-gray-100 dark:border-gray-800 sticky top-24">
              ...
              <div className="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-lg border border-amber-200 dark:border-amber-800 mb-6">
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="text-xs font-bold text-amber-900 dark:text-amber-200">Worldwide Shipping</p>
                    <p className="text-[11px] text-amber-800 dark:text-amber-300 mt-1 leading-relaxed">
                      Shipping costs are determined by weight and delivery zone. We will contact you with the final shipping quote via email/phone.
                    </p>
                    <a href="mailto:shrawanhandicrafts@gmail.com" className="text-[11px] font-bold underline text-amber-900 dark:text-amber-200 block mt-1">
                      shrawanhandicrafts@gmail.com
                    </a>
                  </div>
                </div>
              </div>
